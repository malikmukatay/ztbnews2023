...
if (! function_exists('post_date_format')) {
    function post_date_format(bool $longType = true): string|null
    {
        if ($longType) {
...
if (! function_exists('get_total_comment')) {
    function get_total_comment($object): int|null
    {
        if (is_plugin_active('comment')) {
    ...
    function get_total_like($object): int|null
    {
        if (is_plugin_active('comment')) {
            if (setting('enable_cache')) {
...
function addLoginOptionsByTheme(string|null $html): string
{
